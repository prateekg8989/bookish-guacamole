...
@DynamoDBTable(tableName = "SoldInsurancePolicy")
public class SoldInsurancePolicy {

    @DynamoDBHashKey(attributeName = "insuranceTypeId")
    ...
    @DynamoDBIndexRangeKey(attributeName="vendorId",
            localSecondaryIndexName="insuranceTypeId-vendorId-index")
    ...
    public SoldInsurancePolicy() {
    }

    public SoldInsurancePolicy(String insuranceTypeId, String insuranceTypeName, String vendorId, String vendorName, String policyUin, String policyName) {
